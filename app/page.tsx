...
const physicalSections: Section[] = [
  ...
  },
  {
    ...
    checks: [
      { id: "p6", title: "Continuous step-free route", prompt: "Is there a continuous route to the entrance with no stairs, curbs, or abrupt level changes?", critical: true, source: { label: "2010 ADA Standards", sections: "§§ 206.2.1, 402.2, 303", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#chapter-4-accessible-routes" } },
      { id: "p7", title: "Route is wide enough", prompt: "Is the clear walking surface generally at least 36 inches wide?", measure: "Measure the narrowest point, allowing only short, limited pinch points.", source: { label: "2010 ADA Standards", sections: "§ 403.5.1", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#403-walking-surfaces" } },
      { id: "p8", title: "Surface is usable", prompt: "Is the route firm, stable, slip-resistant, and free of broken pavement, loose gravel, or large gaps?", source: { label: "2010 ADA Standards", sections: "§§ 302.1, 302.3, 403.2", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#302-floor-or-ground-surfaces" } },
      { id: "p9", title: "Slope is manageable", prompt: "Is the route gentle, or properly built as a ramp where it is steeper?", measure: "Walking route: 1:20 (5%) max. Ramp: 1:12 (8.33%) max, with landings and handrails where required.", source: { label: "2010 ADA Standards", sections: "§§ 403.3, 405.2", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#405-ramps" } },
      { id: "p10", title: "Head and cane clearance", prompt: "Is the route free of low branches, signs, and wall-mounted objects that could be head or cane hazards?", measure: "Overhead clearance: 80 in minimum. Objects with leading edges 27–80 in high should not project more than 4 in.", source: { label: "2010 ADA Standards", sections: "§§ 307.2–307.4", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#307-protruding-objects" } },
    ],
  },
  {
    ...
    checks: [
      { id: "p11", title: "Accessible entrance is obvious", prompt: "Is the main entrance accessible, or do clear signs direct people to an equally usable accessible entrance?", critical: true, source: { label: "2010 ADA Standards", sections: "§§ 206.4, 216.6", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#206-accessible-routes" } },
      ...
      { id: "p13", title: "Threshold is low", prompt: "Is the threshold 1/2 inch high or less, with no abrupt edge over 1/4 inch?", measure: "Use a small tape measure at the highest point.", source: { label: "2010 ADA Standards", sections: "§§ 303.2, 303.3, 404.2.5", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#404-doors-doorways-and-gates" } },
      { id: "p14", title: "Hardware is easy to use", prompt: "Can the latch or handle be operated with one hand without tight grasping, pinching, or twisting?", source: { label: "2010 ADA Standards", sections: "§§ 309.4, 404.2.7", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#404-doors-doorways-and-gates" } },
  ...
  },
  {
    ...
    checks: [
      { id: "p16", title: "Accessible restroom is available", prompt: "Is at least one accessible public restroom available, with direction signs if needed?", critical: true, source: { label: "2010 ADA Standards", sections: "§§ 213.2, 216.8", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#213-toilet-facilities-and-bathing-facilities" } },
      { id: "p17", title: "Doorway and route work", prompt: "Is there a step-free route and at least 32 inches of clear door opening into the restroom?", measure: "Check mats, trash cans, and stored items as well as the permanent doorway.", source: { label: "2010 ADA Standards", sections: "§§ 213.2, 404.2.3", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#213-toilet-facilities-and-bathing-facilities" } },
      { id: "p18", title: "Room has turning space", prompt: "Is there enough clear floor area for a wheelchair to turn and approach the fixtures?", measure: "Quick check: look for a 60 in turning circle or a usable T-shaped turning space.", source: { label: "2010 ADA Standards", sections: "§§ 304.3, 603.2.1", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#603-toilet-and-bathing-rooms" } },
      { id: "p19", title: "Toilet transfer space is clear", prompt: "Is there clear space beside the toilet, with no trash can or fixture blocking a side transfer?", critical: true, source: { label: "2010 ADA Standards", sections: "§§ 604.3.1, 604.3.2", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#604-water-closets-and-toilet-compartments" } },
      { id: "p20", title: "Grab bars are present", prompt: "Are secure grab bars installed behind and beside the toilet, and free of obstructions?", critical: true, source: { label: "2010 ADA Standards", sections: "§§ 604.5, 609", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#604-water-closets-and-toilet-compartments" } },
      { id: "p21", title: "Sink and controls are reachable", prompt: "Can a wheelchair user approach the sink, use the faucet, soap, and hand-drying equipment?", measure: "Quick reach check: operable parts should generally be no higher than 48 in; pipes below the sink should be protected.", source: { label: "2010 ADA Standards", sections: "§§ 308, 309.4, 606.2–606.5", href: "https://www.ada.gov/law-and-regs/design-standards/2010-stds/#606-lavatories-and-sinks" } },
    ],
  },
  {
...
const modules: Record<ModuleId, CheckupModule> = {
  physical: {
    id: "physical", number: "01", name: "Likely physical barriers", description: "Go through parking, arrival, entrances, restrooms, and access to services.", meta: "About 20 minutes · 26 checks",
    eyebrow: "QUICK PHYSICAL BARRIERS CHECK-UP", title: "Likely physical barriers to access.", lede: "A quick, guided check-up for common physical barriers to accessibility—no experience required.",
  ...
  event: {
    ...
    eyebrow: "QUICK EVENT ACCESSIBILITY CHECK-UP", title: "Plan for participation.", lede: "A guided check-up of the information, venue, activities, and communication that shape an accessible event.",
    notice: "It flags common access gaps in event planning and delivery, but is not a comprehensive event accessibility checklist. Responsibilities and potential solutions depend on the organizer, venue, event, and needs of attendees.", subjectLabel: "Event name", subjectPlaceholder: "Community Open House", locationLabel: "Venue or location", locationPlaceholder: "Civic Hall or online", prep: ["Event details", "Venue map", "Staff contact"],
  ...
  digital: {
    ...
    eyebrow: "QUICK DIGITAL ACCESSIBILITY CHECK-UP", title: "Make your ideas available to everyone.", lede: "A guided check-up for common accessibility barriers of digital content and experiences.",
      ...
      {screen === "landing" && (
        <section className="landingPage">
          <div className="landingHero">
            ...
            <p className="lede">Accessibility allows more people to participate in all of life's experiences. A quick check-up can reveal barriers before they exclude someone.</p>
          </div>
          ...
          <div className="whyGrid" aria-label="Why accessibility matters">
            ...
            <div><strong>Better experiences</strong><p>Clearer, more flexible experiences work better for everyone.</p></div>
          </div>
          <div className="moduleHeading"><div><div className="eyebrow">CHOOSE A CHECK-UP</div><h2>What would you like to review?</h2></div><p>Each check-up is a guided preliminary screening and not a full compliance determination.</p></div>
          ...
          <div className="checks">
            {current.checks.map((q, index) => {
              ...
              return <article className={`checkCard ${answer.result || ""}`} key={q.id}>
                ...
                <a className="citation" href={q.source.href} target="_blank" rel="noreferrer" aria-label={`Source: ${q.source.label} ${q.source.sections}`}><span>Source</span> {q.source.label} {q.source.sections} ↗</a>
